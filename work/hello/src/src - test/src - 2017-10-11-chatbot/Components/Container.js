...
const Container = React.createClass({
  ...
  renderNoDataText() {
    return (
      <div>
        <TextContainerComponent message="No Data Available" />
      </div>
    )
  },
  ...
  render () {
    return (
      (this.props.updated) ? ((this.props.isQuickReply ? this.renderQuickReplyComponent() : ((this.props.isTextView ? this.renderTextContainerComponent() : ((this.props.isCarousalDataEmpty) ? this.renderNoDataText() : this.renderCarosualComponent()))))) : this.renderLoading()
    )
  }
})
