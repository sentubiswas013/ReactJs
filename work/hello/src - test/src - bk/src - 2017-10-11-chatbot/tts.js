  ...
  parent.indiantts=function(userText) {
    ...
    var myAudio = new Audio(this.responseText);
    myAudio.play();
     }
    });

    xhr.open("POST","http://indianttsvoice.com/tts")
    xhr.setRequestHeader("content-type", "application/x-www-form-urlencoded");
    var resultantData = 'text='+data+'&api_key=7GmTVxWyGXYDxeCPhmOvvQhEH9PrtKaRsbHk28jqkisWu'
    xhr.send(resultantData);
    }
