...
### 3. **What are new feature added in angular 18?**
...
### 7. **What is a Decorators in Angular?**
...
### 18. What is the steps to update Angular older version to current version?
...
### 83. **What is the difference between `switchMap`, `concatMap`, and `mergeMap` in RxJS? Provide examples of when to use each.**
...
### 87. **How does Angular handle state management, and what libraries can be used for state management in Angular applications?**
...
### 88. **What is Ahead-of-Time (AOT) compilation, and how does it differ from Just-in-Time (JIT) compilation?**
...
### 89. **What are Angular Universal applications, and how does server-side rendering work in Angular?**
...
### 91. **How do you configure Angular to work with environment-specific settings (e.g., production vs development)?**
...
### 93. **How to implement authgaurd n angular?**
...
### 102. **How would you troubleshoot performance issues in Angular? What tools and techniques would you use?**
...
### 103. **How do you handle error handling in RxJS streams?**
...
### 104. **What is a `Subject` and `BehaviorSubject` in Angular RxJS? How are they different?**
...
### 105. **Explain the difference between `ngOnInit()` and `constructor()` in Angular. When would you use each one?**
...
### 112. **How do you implement routing in Angular, and what are the different navigation methods available?**
