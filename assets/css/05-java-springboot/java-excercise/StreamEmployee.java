...
static class Employee {
    ...
    public static void main(String[] args) {
        ...
        Map<String, List<Employee>> departmentList = empList.stream()
        ...
        List<Employee> lessThan30 = empList.stream()
        ...
        List<Employee> salaryRange = empList.stream()
        ...
        Map<String, Double> avgAgeByGender = empList.stream()
                .collect(Collectors.groupingBy(
                        Employee::getGender,
        ...
        Entry<String, Long> maxDept = empList.stream()
                .collect(Collectors.groupingBy(
                        Employee::getDepartmentName,
                        Collectors.counting()
                ))
        ...
        List<Employee> delhiEmployees = empList.stream()
        ...
        Map<String, Optional<Employee>> highestSalaryEmployee = empList.stream()
                .collect(Collectors.groupingBy(
                        Employee::getDepartmentName,
                        Collectors.maxBy(
        ...
        List<Employee> sortedBySalary = empList.stream()
